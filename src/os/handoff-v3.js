...
const FINAL_REPORT_POINTS = Object.freeze([
  ...
  "API проверки: /api/os/config (v3, 33), /api/sdk/* (14 SDK), /api/infra/*, /api/l2/router, /api/game-signals/config, /api/assets/strategy, /api/os/control-panels (19), /api/os/handoff, /api/os/final-report — все с ?gameId=aof.",
