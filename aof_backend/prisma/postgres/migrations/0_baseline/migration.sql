-- GENERATED by scripts/gen-postgres-schema.py: all SQLite migrations squashed into one PostgreSQL baseline.
...
CREATE TABLE "EconomySnapshot" (
    ...
    "inflation24h" DOUBLE PRECISION NOT NULL,
...
CREATE TABLE "FarmPlot" (
    ...
    "expandedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE "PlayerRating" (
    ...
    "comment" TEXT,
    "stakeWeight" DOUBLE PRECISION NOT NULL DEFAULT 1.0
);
...
CREATE TABLE "PriceTick" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "rarity" INTEGER NOT NULL,
    "priceMascot" DOUBLE PRECISION NOT NULL,
...
CREATE TABLE "TrustScore" (
    ...
    "penaltyMult" DOUBLE PRECISION NOT NULL DEFAULT 1.0,
    "computedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
-- ===== from 202609200001_reward_reconciliation =====
...
-- ===== from 202609200002_reward_receipts =====
...
-- ===== from 202609200003_reconciliation_cursor =====
...
-- ===== from 202609210001_chain_indexer =====
