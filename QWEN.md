# aof — Game Repo
gameId: aof
Watchtower: Games-watchtower adapter knows aof
Program ID: solana-keygen new -o target/deploy/aof-keypair.json && solana address -k target/deploy/aof-keypair.json
Paths: programs/aof/src/lib.rs or programs/aof-quests/
