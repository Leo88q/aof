...
> Продолжение: [W1.2 / issuance journal](AOF_ECONOMY_W1_2.md). Предыдущий полный CI
> `02f8223` прошёл; новые экономические изменения и дополнительные риски описаны отдельно.
