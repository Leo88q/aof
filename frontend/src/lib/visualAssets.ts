...
export const PLAYABLE_RESOURCES: ResourceVisual[] = [
  { id: "neuron", name: "Нейрон", en: "Neuron", plate: "/assets/nfts/resources/neuron.jpg", group: "playable" },
  { id: "synapse", name: "Синапс", en: "Synapse", plate: "/assets/nfts/resources/synapse.jpg", group: "playable" },
  { id: "power", name: "Энергопоток", en: "Power", plate: "/assets/nfts/resources/power.jpg", group: "playable" },
  { id: "circuit", name: "Схема", en: "Circuit", plate: "/assets/nfts/resources/circuit.jpg", icon: "/assets/icons/circuit.jpg", group: "playable" },
  { id: "silicon", name: "Кремний", en: "Silicon", plate: "/assets/nfts/resources/silicon.jpg", group: "playable" },
  { id: "signal", name: "Сигнал", en: "Signal", plate: "/assets/nfts/resources/signal.jpg", group: "playable" },
  { id: "model", name: "Модель", en: "Model", plate: "/assets/nfts/resources/model.jpg", group: "playable" },
  { id: "compute", name: "Вычислительный цикл", en: "Compute", plate: "/assets/nfts/resources/compute.jpg", group: "playable" },
  { id: "dataset", name: "Датасет", en: "Dataset", plate: "/assets/nfts/resources/dataset.jpg", group: "playable" },
  { id: "data", name: "Данные", en: "Data", plate: "/assets/nfts/resources/data.jpg", icon: "/assets/icons/data.jpg", group: "playable" },
  { id: "clearQuartz", name: "Чистый кварц", en: "Clear Quartz", plate: "/assets/nfts/resources/clear-quartz.jpg", group: "playable" },
