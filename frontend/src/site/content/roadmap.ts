...
export const roadmapItems: RoadmapItem[] = [
  ...
  { id: 'r3', era: 'done', title: 'Контент и каталог', bullets: ['28 ресурсов с нарративами', '26 механик с шагами и инструкциями', 'Рданныекционная книга рецептов и 6 способов торговли'] },
  { id: 'r4', era: 'done', title: 'MIND-мост', bullets: ['Происхождение и 5 способов расхода', 'Правила burn-механик', 'Голоса мастеров о токене'] },
  { id: 'r5', era: 'now', title: 'Визуальная полнота', bullets: ['Демо погоды и эпохное колесо', 'Мданныельоны тиров и карточки редкостей', 'Журнал отметок и цепочка труда на главной'] },
  ...
  { id: 'r11', era: 'later', title: 'Гильдейские занятия', bullets: ['Совместные квесты и челленджи', 'Территории и войны эпохов', 'Общие мастерские гильдий'] },
