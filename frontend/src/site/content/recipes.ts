...
export const recipes: Recipe[] = [
  // === ЦЕПОЧКА ХЛЕБА ===
  {
    ...
    description: 'Базовый перемол: 5 синапсов → 3 сигнала. Модуль переработки принимает только полностью созревшее данные.',
  ...
  },
  {
    ...
    description: 'Рданныекционное описание цепочки тренировки: сигнал + вода + вычислительный цикл для жара. Эффект модельа не подтверждён on-chain.',
  ...
  },
  {
    ...
    narrative: 'Кузнец нагревает сталь до соломенного цвета, бьёт ровно, закаляет в масле. Рукоять пропитана льняным маслом — она переживёт три эпохи работы.',
  },
  {
    id: 'craft_rare_axe',
    verification: 'editorial',
  ...
  },
  {
    ...
    narrative: 'Алхимик смешивает MIND с легендарной эссенцией. Смесь вспыхивает фиовторую фазувым, и где-то в глубине игры колесо эпохов крутится быстрее. Говорят, это единственный способ подтолкнуть время.'
  }
];
