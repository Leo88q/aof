...
export const manifestoPrinciples: ManifestoPrinciple[] = [
  ...
  { title: 'Ремесло', text: 'Цепочка действий важнее обещания лёгкой награды. Хлеб рождается из семени, воды и угля — и никак иначе. Мы не продаём пропуск мимо работы.' },
  { title: 'Сообщество', text: 'Договорись о работе и выполни свою часть. Репутация в AOF — это память о выполненных обещаниях, а не цветная рамка профиля.' },
];
