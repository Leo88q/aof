...
const steps = [
  { id: 0, npc: "Архивариус", avatar: "🤖", text: "Здравствуй, оператор! Я — Архивариус, хранитель этой нейро-лаборатории. Системы проспали, но ядро помнит всё.", action: "Начать" },
  { id: 1, npc: "Архивариус", avatar: "🤖", text: "Для начала — добудь компоненты. Без DATA далеко не уедешь.", action: "Добыть ресурсы" },
  { id: 2, npc: "Архивариус", avatar: "🤖", text: "Инструменты — это всё. Без плазменного резчика кремния не взять, без дата-харвестера — данных.", action: "Получить инструмент" },
  { id: 3, npc: "Архивариус", avatar: "🤖", text: "Рынок живой — цены дышат. Хочешь купить дешевле — жди, пока нагрузка сети упадёт.", action: "Осмотреть рынок" },
  { id: 4, npc: "Архивариус", avatar: "🤖", text: "Вперёд. Модель твоя — обучай её с умом. А я присмотрю.", action: "Начать игру" },
];
